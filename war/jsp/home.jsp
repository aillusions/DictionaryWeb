...
<html>
  ...
  <style>
	  .clearall{
		...
		.words {font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:14; height:20px;  overflow: hidden; border-bottom-width: 0 !important; margin: 0 .2em -1px 0; padding: 0; }
  </style>
  
  </head>
  <body> 
 	
    <c:forEach items="${manager.workspaceManager.workspace.dictioanries}" var="dict">    
    	<a href="home.do?dictName=${dict.displayName}"><c:out value="${dict.displayName}"  /></a><br/>
    </c:forEach>
    
    <a href="home.do?reloadDict=true">Reload</a><br/>
